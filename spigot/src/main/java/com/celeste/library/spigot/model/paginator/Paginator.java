...
/**
 * The Paginator interface is the main
 * creator for paginators.
 *
 ...
 * {@link MenuPaginatorImpl} for Object paginator with Menu features}</p>
 */
public interface Paginator<T> {
  ...
  /**
   * Checks if the Paginator contains the page in that
   * index.
  ...
  /**
   * This can only be used for {@link MenuPaginatorImpl},
   * it creates the default previous and next items in the menu
   */
  void setup(final Integer[] slots);

  /**
   * Gets the items contained on the page
   * specified.
   * @param index int
   *
   * @return Set
