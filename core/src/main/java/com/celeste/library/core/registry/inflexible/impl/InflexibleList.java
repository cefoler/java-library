package com.celeste.library.core.registry.inflexible.impl;

import com.celeste.library.core.registry.collection.Collection;
import com.celeste.library.core.registry.inflexible.AbstractInflexible;
import com.celeste.library.core.registry.inflexible.Inflexible;
...
public final class InflexibleList<V> extends AbstractInflexible<V>
  ...
  public InflexibleList(final Supplier<MapRegistry<V, Object>> supplier) {
    this(InflexibleType.ARRAY, supplier);
  }

  public InflexibleList(final InflexibleType type, final Supplier<MapRegistry<V, Object>> supplier) {
