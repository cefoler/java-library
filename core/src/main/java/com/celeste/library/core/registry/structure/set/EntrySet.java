...
import com.celeste.library.core.registry.structure.splitter.impl.EntrySplitter;
...
public final class EntrySet<K, V> extends AbstractSet<Entry<K, V>> {
  ...
  public Spliterator<Entry<K, V>> spliterator() {
    return new EntrySplitter<>(registry, null, 0, -1, 0, 0);
  }

  public void forEach(@NotNull final Consumer<? super Entry<K, V>> action) {
